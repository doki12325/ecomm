...
function Cart() {
  ...
  return (
    <div className={styles.main}>
      ...
      {dataContext.cart.totalQuantity !== 0 && (
        <>
            ...
            {dataContext.cart.cartData.map((data, index) => (
              <div className={styles.cartItem}>
                ...
                <div className={styles.itemDetails}>
                  <div className={styles.itemName}>{data.product.name}</div>
                  <div className={styles.itemPrice}>
                    ${data.product.price * (data.product.discount / 100)} x
                    {"  "}
                    {data.quantity}{" "}
                    <span>
                      $
                ...
                <button
                  ...
                  onClick={(e) => {
                    ...
                    dataContext.setCart((prev) => ({
                      ...prev,
                      cartData: prev.cartData.filter((_, i) => i !== index),
